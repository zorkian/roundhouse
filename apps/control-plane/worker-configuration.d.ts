/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/control-plane/wrangler.jsonc --include-runtime=false apps/control-plane/worker-configuration.d.ts` (hash: 2f8528a334e0326aa2219bde96a94054)
