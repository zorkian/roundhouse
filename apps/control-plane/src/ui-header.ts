...
export function renderSiteHeader(account?: HeaderAccount): string {
  ...
  const user = account
    ...
    : "";
  return `<header class="site-header"><div class="site-header-inner"><a class="site-brand" href="/">Roundhouse</a><nav class="site-nav" aria-label="Primary navigation"><a href="/">Runs</a><a href="/conversations">Conversations</a><a href="/usage">Model usage</a></nav>${user}</div></header>`;
}
