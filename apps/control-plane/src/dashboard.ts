...
<p class="secondary">Runs across enrolled repositories</p><div class="summary"><span><strong>${attention.length}</strong> need attention</span><span><strong>${active.length}</strong> in progress</span><span><strong>${finished.length}</strong> recently finished</span></div>
