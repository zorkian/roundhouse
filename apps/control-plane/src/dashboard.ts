...
</style></head><body><header><div class="heading"><h1>Roundhouse</h1><span class="env-badge">Development</span></div><p>Development runs across enrolled repositories${user ? ` · Signed in as ${escapeHtml(user.githubLogin)} · <a href="/auth/sign-out">Sign out</a>` : ""}</p></header><main>
