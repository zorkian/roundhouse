...
## Summary
- 1622 nodes · 3873 edges · 76 communities (64 shown, 12 thin omitted)
...
Cohesion: 0.07
Nodes (10): pauseForModelBudget(), attemptFromRow(), D1RunRepository, Statement, usageFromRow(), input, LocalD1, LocalD1Statement (+2 more)

### Community 2 - "coordinate"
Cohesion: 0.14
Nodes (17): coordinate(), coordinateCompetition(), dispatchCompetitionAttempt(), dispatchReview(), effectiveAttemptCapabilities(), finalizePromotion(), recordAttemptOutcomeTransition(), recordIssuedCapabilities() (+9 more)

### Community 3 - "d1-store.ts"
Cohesion: 0.05
Nodes (74): ActiveAttemptLease, AttemptExecutionRecordOutcome, AttemptRow, Result, RunDetails, RunRow, RunSummary, UsageRow (+66 more)

### Community 4 - "attempt-container.ts"
Cohesion: 0.06
Nodes (30): attemptAllowedHosts(), AttemptAssignment, attemptCompletion(), attemptUsesProjectEnvironment(), containerRegistryHosts, extractModelUsage(), ModelPrice, ModelRates (+22 more)
...
Cohesion: 0.07
Nodes (45): commit, workflowRun(), defaultBlockingSeverities, defaultConversationModel, defaultReviewerModels, defaultStageModels, enumList(), findingSeverities (+37 more)
...
Cohesion: 0.13
Nodes (23): applyHostedResearch(), brokerRequest(), cloudflareStopReason(), defaultRoutes, endpointProtocol(), nativeHeaders(), nativeModel(), nativePath() (+15 more)

### Community 9 - "github.ts"
Cohesion: 0.05
Nodes (47): ConversationWorkerDependencies, acceptGitHubComment(), acceptGitHubIssueClosed(), appJwt(), bytesToBase64Url(), CommentPayload, concludedNoChangeQualification(), conversationPromotionMarker() (+39 more)
...
### Community 11 - "resolveRoute"
Cohesion: 0.29
Nodes (10): configuredModels(), configuredRoutes(), defaultProtocol(), defaultTransport(), resolveRoute(), routeFromHeaders(), routingRule(), validProviderNativeProtocol() (+2 more)
...
Cohesion: 0.12
Nodes (21): artifactRepositoryName(), AttemptNamespace, AttemptRuntimeEnv, attemptSandbox(), AttemptStub, attemptWorkspaceRef(), checkpointIdentityExpectation(), checkpointIdentityRejection() (+13 more)
...
Cohesion: 0.10
Nodes (6): AttemptReporter, AttemptDiagnosticSnapshot, Attempt, Lease, MemoryRunRepository, RunStage
...
Cohesion: 0.13
Nodes (28): modelEgress(), recordModelEvent(), AttemptPreparationEnv, AttemptWorkflowParams, artifactsNamespace(), sandboxName(), SandboxNamespace, acceptRecordedAttemptCompletion() (+20 more)
...
Cohesion: 0.06
Nodes (26): artifactNeedsSync(), attemptArtifactAccess(), destroyAttemptSandboxWithTrace(), SandboxDestructionTrace, competitionPromoter(), webInboundMessage(), AttemptTransportStatus, controlPlaneService (+18 more)
...
Cohesion: 0.17
Nodes (21): Checkpoint, AttemptBackupResult, AttemptPublicationResult, AttemptSettlementOutcome, AttemptValidationResult, callbackForCompletion(), observedBranchHead(), settleAttempt() (+13 more)
...
Cohesion: 0.17
Nodes (12): ConversationAdapter, VerifiedConversationActor, webConversationAdapter, ProtocolAdapter, ConversationQueue, conversationWakeupRedeliveryMilliseconds, deliverPendingConversationReplies(), publishConversationWakeup() (+4 more)
...
- **Why does `observeResponse()` connect `ui-auth.ts` to `runner.mjs`, `attempt-container.ts`, `model-broker/src/index.ts`, `github.ts`, `attempt-dispatch.ts`, `artifacts.ts`, `attempt-workflow.ts`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `D1RunRepository` connect `D1RunRepository` to `coordinate`, `coordinator.ts`, `attempt-container.ts`, `d1-store.ts`, `control-plane/src/index.ts`, `liveness.ts`, `attempt-dispatch.ts`, `attempt-runtime.ts`, `artifacts.ts`, `attempt-workflow.ts`, `attempt-settlement.ts`, `conversation-liveness.ts`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `RunSnapshot` connect `core/src/index.ts` to `D1RunRepository`, `coordinate`, `coordinator.ts`, `d1-store.ts`, `control-plane/src/index.ts`, `workflow-view.ts`, `github.ts`, `contracts.ts`, `attempt-dispatch.ts`, `createRun`, `attempt-runtime.ts`, `Attempt`, `github-ci.ts`, `attempt-settlement.ts`, `workflow-view.test.ts`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
