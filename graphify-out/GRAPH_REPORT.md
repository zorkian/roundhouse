...
## Corpus Check
- 152 files · ~254,750 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1717 nodes · 4133 edges · 103 communities (85 shown, 18 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 24 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c5f1ae50`
...
Cohesion: 0.05
Nodes (99): activityRequest(), adjudicate(), adjudicationPrompt(), adjudicationSchema, agentRuntime, agentSystemPrompt, agentToolNames(), artifactWriteTokenRequest() (+91 more)

### Community 1 - "D1RunRepository"
Cohesion: 0.09
Nodes (10): modelEgress(), pauseForModelBudget(), recordModelEvent(), attemptFromRow(), D1RunRepository, Statement, usageFromRow(), repositoryContract() (+2 more)
...
Cohesion: 0.13
Nodes (38): seedPreImplementationResults(), attemptLinks(), attemptResult(), boundaryWorkflowEvidence(), ciResult(), CompetitionGroup, competitionGroups(), competitionPanels() (+30 more)
...
Cohesion: 0.10
Nodes (18): anthropicMessagesAdapter, briefSchema, ConversationFirstReply, decodeBase64Utf8(), executeRepositoryTool(), firstReplySchema, FunctionCall, googleGenerativeAiAdapter (+10 more)

### Community 8 - "model-broker/src/index.ts"
Cohesion: 0.09
Nodes (42): applyFailureHeaders(), applyHostedResearch(), BrokerEnv, brokerRequest(), cloudflareShaped(), configuredModels(), configuredRoutes(), defaultProtocol() (+34 more)

### Community 9 - "github.ts"
Cohesion: 0.16
Nodes (24): appJwt(), bytesToBase64Url(), CommentPayload, findOpenPullRequest(), findPullRequest(), implementationComment(), implementationNoChangeComment(), IssuePayload (+16 more)

### Community 10 - "conversation-ui.ts"
Cohesion: 0.16
Nodes (27): Conversation, actionableConversationStatus, briefEditor(), controlsHtml(), conversationPollingActive(), ConversationPollState, conversationStatus(), ConversationStatusInput (+19 more)
...
Cohesion: 0.07
Nodes (31): Approval, ApprovalPurpose, approvalPurposes, AttemptCompetition, AttemptKind, attemptKinds, AttemptOutcome, AttemptState (+23 more)

### Community 13 - "attempt-dispatch.ts"
Cohesion: 0.10
Nodes (30): attemptContext(), AttemptEventRepository, AttemptPreparationEnv, AttemptWorkflowBinding, canonicalAttempts(), competitionAttemptBaseRole(), competitionForAttempt(), DurableAttemptDispatcher (+22 more)

### Community 14 - "coordinator.ts"
Cohesion: 0.12
Nodes (28): attemptInactivityMilliseconds, aggregateReviewAttempts(), AttemptDispatcher, attemptOutcomeTransition(), ciTransition(), CompetitionStep, evidenceForAttempt(), graphCompletedTransition() (+20 more)

### Community 15 - "attempt-runtime.ts"
Cohesion: 0.10
Nodes (29): Checkpoint, artifactRepositoryName(), AttemptRuntimeEnv, attemptSandbox(), checkpointIdentityExpectation(), checkpointIdentityRejection(), checkpointIdentityRejectionDetails, cleanupCheckpointResources() (+21 more)

### Community 16 - "workflow.ts"
Cohesion: 0.06
Nodes (36): ModelThinkingLevel, WaitingReason, condition(), executorCapabilities, outputPaths(), path(), scalar(), taskContracts (+28 more)

### Community 17 - "Attempt"
Cohesion: 0.11
Nodes (4): AttemptReporter, Attempt, Lease, MemoryRunRepository
...
Cohesion: 0.07
Nodes (37): acceptGitHubCheckSuite(), acceptGitHubPullRequest(), actionsJobLink(), aggregateReview(), atWorkflowExecutor(), checkEvidence(), CheckRun, checkRuns() (+29 more)
...
Cohesion: 0.12
Nodes (32): AttemptWorkflowParams, artifactsNamespace(), attemptWorkspaceBackupKey(), sandboxName(), saveWorkspaceBackup(), acceptRecordedAttemptCompletion(), AttemptBackupResult, AttemptPublicationResult (+24 more)
...
Cohesion: 0.14
Nodes (25): ActiveAttemptLease, AttemptDiagnosticSnapshot, AttemptExecutionRecordOutcome, AttemptRow, Result, RunRow, UsageRow, AppliedProfile (+17 more)
...
Cohesion: 0.13
Nodes (10): loadDefaultBranchProfile(), loadRepositoryProfile(), resolveDefaultBranchCommit(), closureDelivery(), concludeQualification(), delivery(), IntakeRepository, reportedBodyWithDetails() (+2 more)

### Community 28 - "D1ConversationRepository"
Cohesion: 0.21
Nodes (4): D1ConversationRepository, turnFromRow(), wakeupOutboxId(), processConversationWakeup()
...
Cohesion: 0.05
Nodes (27): artifactNeedsSync(), attemptArtifactAccess(), AttemptNamespace, AttemptStub, destroyAttemptSandbox(), destroyAttemptSandboxWithTrace(), SandboxDestructionTrace, competitionPromoter() (+19 more)

### Community 35 - "conversation-engine.test.ts"
Cohesion: 0.24
Nodes (8): conversationQueueRetryDelaySeconds(), modelCallBackoffMs(), parseRetryAfterSeconds(), conversation, github, responsesRoute, turn, retryResult()
...
Cohesion: 0.18
Nodes (14): extractModelUsage(), call(), endAt, usageTable(), formatUsage(), formatUsageBreakdown(), ModelUsageDay, ModelUsageModelTotal (+6 more)
...
Cohesion: 0.17
Nodes (10): resolveWorkflowContexts(), resumeExternalWorkflowEvent(), commit, head, profileFor(), runWith(), WorkflowContextProvider, WorkflowContextRequest (+2 more)
...
### Community 57 - "attempt-container.ts"
Cohesion: 0.13
Nodes (15): AttemptAssignment, attemptCompletion(), containerRegistryHosts, PreparedAttempt, RunnerHttpResult, record(), validAttemptCompletion(), modelErrorCodesHeader (+7 more)
...
### Community 84 - "acceptGitHubComment"
Cohesion: 0.24
...
### Community 86 - "createRun"
Cohesion: 0.22
Nodes (7): runFixture(), workflowPageDb(), workflowRun(), input, commit, workflowRun(), createRun()
...
### Community 89 - "GitHubApi"
Cohesion: 0.19
Nodes (6): ConversationWorkerDependencies, GitHubApi, GitHubStageReporter, listComments(), postRunCommentOnce(), runDetailsUrl()
...
Cohesion: 0.18
Nodes (9): ConversationExecutionResult, ConversationModelCallError, ProtocolAdapter, ConversationCallUsage, ConversationMessage, ConversationTurn, DeliveryBrief, RoutingEnvelope (+1 more)

### Community 94 - "workflow.test.ts"
Cohesion: 0.60
...
### Community 99 - "safe-markdown.ts"
Cohesion: 0.22
Nodes (6): marked, reviewFindings(), markdownLinkProtocols, renderSafeMarkdown(), safeMarkdown, marked

### Community 100 - "executeConversationTurn"
Cohesion: 0.25
Nodes (9): adapterFor(), Broker, conversationInstructions(), executeConversationTurn(), parseBrief(), parseFirstReply(), resolveConversationRoute(), stringArray() (+1 more)

### Community 101 - "callModel"
Cohesion: 0.40
Nodes (5): brokerFailureFields(), brokerHeaders(), callModel(), conversationModelErrorFields(), sleep()
...
- **Why does `observeResponse()` connect `observeResponse` to `runner.mjs`, `D1RunRepository`, `RoundhouseRuntimeSandbox`, `ui-auth.ts`, `model-broker/src/index.ts`, `github.ts`, `attempt-dispatch.ts`, `index.mjs`, `artifacts.ts`, `attempt-container.ts`, `conversation-promotion.ts`, `CloudflareArtifactsNamespace`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `D1RunRepository` connect `D1RunRepository` to `control-plane/src/index.ts`, `coordinate`, `dashboard.ts`, `attempt-dispatch.ts`, `coordinator.ts`, `attempt-runtime.ts`, `usage.ts`, `attempt-settlement.ts`, `createRun`, `core/src/index.ts`, `attempt-container.ts`, `conversation-worker.ts`, `liveness.ts`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `Attempt` connect `Attempt` to `D1RunRepository`, `run-details.ts`, `github.ts`, `coordinate`, `contracts.ts`, `attempt-dispatch.ts`, `coordinator.ts`, `attempt-runtime.ts`, `github-ci.ts`, `attempt-settlement.ts`, `core/src/index.ts`, `github.test.ts`, `aggregated-review.ts`, `control-plane/src/index.ts`, `attempt-container.ts`, `run-details.test.ts`, `acceptGitHubComment`, `createRun`, `GitHubApi`, `.promote`?**
...
- **Should `runner.mjs` be split into smaller, more focused modules?**
  _Cohesion score 0.05368360936607653 - nodes in this community are weakly interconnected._
